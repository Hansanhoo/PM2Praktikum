...
class DVD implements Medium
{
    ...
    /**
     * Gibt Alle Eigenschaften der DVD zurück.
     * 
	...
	{
		return String.format("Titel: %s , Regisseur: %s , Kommentar: %s , Laufzeit: %d , Medium: %s", _titel , _regisseur , _kommentar , _laufzeit , getMedienBezeichnung());
	}
