        ...
        VerleihService
{
    ...
    {
    	assert mediumImBestand(medium) : "Vorbedingung verletzt: (medium nicht verliehen)";
    ...
    {
    	assert kundeImBestand(kunde) : "Vorbedingung verletzt: (Kunde nicht vorhanden)";
    	assert (medienImBestand(medien)) : "Vorbedingung verletzt: (medium nicht im Bestand)";
    ...
    {    	
    	assert sindAlleVerliehen(medien) : "Vorbedingung verletzt Medium verliehen!";
    	assert rueckgabeDatum != null : "Vorbedingung verletzt rueckgabeDatum nicht vorhanden!";
    ...
    {
    	assert kundeImBestand(kunde) : "Vorbedingung verletzt: (Kunde nicht vorhanden)";
    	assert sindAlleNichtVerliehen(medien) : "Vorbedingung verletzt Medium verliehen!";
    	assert ausleihDatum != null : "Vorbedingung verletzt ausleih Datum nicht vorhanden!";
    ...
    {
    	assert kunde != null : "Kunde nicht vorhanden!";
    ...
    {
    	assert medium != null :"Medium nicht vorhanden !";    	
    ...
    {
    	assert medien != null :"Medium nicht vorhanden !";    
    	assert !medien.isEmpty() : "Medium schon vorhanden";
    ...
    {    	
    	assert istVerliehen(medium) : "Vorbedingung verletzt: (Medium nicht verliehen)";
