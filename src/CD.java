...
class CD implements Medium
{
    ...
    /**
     * Gibt Alle Eigenschaften der CD zurück.
     * 
	...
	{
		return String.format("Interpret:%s , Titel: %s , Kommentar: %s , Laenge: %d , Medium: %s", _interpret, _titel, _kommentar , _spiellaenge , getMedienBezeichnung());
	}
